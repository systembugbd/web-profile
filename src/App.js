            ...
            <div className="h-screen fade-in">

                {
                    error ? (
                        ...
                        <Fragment>
                            <div className="min-h-full p-4 lg:p-10 bg-base-200">
                            ...
                            <footer className="p-4 footer bg-base-200 text-base-content footer-center">
                                <div>
                                    <p className="font-mono text-sm">Made with <a className="text-primary" href="https://github.com/systembugbd/web-profile" target="_blank" rel="noreferrer">Web-Profile</a> and ❤️</p>
                                </div>
                            </footer>
                        </Fragment>
                    )
